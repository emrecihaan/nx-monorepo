...
@Component({
    ...
    templateUrl: './crud-data-grid.component.html',
    styleUrl: './crud-data-grid.component.scss'
})
export class CrudDataGridComponent implements OnInit {
    ...
    @Output() rowInsert = new EventEmitter<any>();
    ...
    onRowInserting(e: any) {
        this.rowInsert.emit(e.data);
    }

    onRowRemoving(e: any) {
        // this.rowDelete.emit(e.data);
    }

    onRowUpdating(e: any) {
        // this.rowUpdate.emit(Object.assign({}, e.oldData, e.newData));
        const oldData = e.oldData;
        const newData = e.newData;
